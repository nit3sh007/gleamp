...
// import useFetchNews from '../config/useFetchNews'; // Assuming you've already created this

// // Keep these components in the SearchPage for now
// const MobileNewsCard = ({ headline, source, publishedAt, category, url, imageUrl }) => {
//   // Format time in a more relevant way
//   const formatTimeAgo = (dateString) => {
//     const published = new Date(dateString);
//     const now = new Date();
//     const diffHours = Math.round((now - published) / (1000 * 60 * 60));
    
//     // Format time in the most relevant unit
//     if (diffHours < 24) {
...
//             <h2 className="text-base sm:text-lg font-bold mb-2">{headline}</h2>
//             <div className="flex items-center text-gray-400 text-sm">
//               <div className="flex items-center">
//                 <span className="text-gray-400">{source || 'News'}</span>
//                 <span className="mx-2">•</span>
//                 <span>{formatTimeAgo(publishedAt)}</span>
//                 {category && category.toLowerCase() !== 'news' && (
//                   <>
//                     <span className="mx-2">•</span>
//                     <span>{category}</span>
//                   </>
...
// // Keep the original TopStoryCard for the top stories section
...
//   // Using the custom news fetching hook
//   const { news, loading, error } = useFetchNews(locationManager.selectedCountry, locationManager.locationLoaded);
...
//         {/* Using the extracted SearchHeader component */}
//         <SearchHeader 
...
//                 {/* Added "What's New Today" title with underline */}
//                 <h2 className="text-white text-xl font-bold px-4 pb-4 border-b-2 border-white inline-block mb-4">What's New Today</h2>
...
//                       // Use the MobileNewsCard with improved responsive design
//                       categoryFilteredNews.map(item => (
//                         <MobileNewsCard
//                           key={item._id}
...
//                     {categoryFilteredNews.slice(0, 4).map((item) => (
//                       <TopStoryCard
//                         key={item._id}
//                         title={item.headline}
...
//           {/* Mobile-only top stories section - more compact */}
...
//       {/* Country Filter - positioned properly */}
//       <CountryFilter 
...
// const CategoryBadge = ({ name, isSelected, onClick }) => (
//   <button
...
//         {/* Category filter bar */}
//         <div className="bg-black border-b border-gray-800 px-4 py-3 overflow-x-auto whitespace-nowrap">
